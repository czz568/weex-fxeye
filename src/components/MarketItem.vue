		...
		<div class="list-item" @click="jump" :key="index" v-for="(item,index) in marketLists">
			<div class="item-l">
				...
				<div class="user">
					...
					<div class="icon-pic" v-if="item.isvip"><image class="icon-img" src="http://192.168.1.100:8081/src/assets/images/icon_vip.png"></image></div>
					<text class="job">{{item.identity}}</text>
					<div class="icon-pic" v-if="item.isphone"><image class="icon-img" src="http://192.168.1.100:8081/src/assets/images/icon_phone.png"></image></div>
					<div class="icon-pic" v-if="item.iswechat"><image class="icon-img" src="http://192.168.1.100:8081/src/assets/images/icon_wechat.png"></image></div>
					<div class="icon-pic" v-if="item.isqq"><image class="icon-img" src="http://192.168.1.100:8081/src/assets/images/icon_qq.png"></image></div>
